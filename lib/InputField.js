...
const InputField = (props) => {
    ...
    const renderField = () => {
        switch (type) {
            ...
            case 'range':
                return (_jsx(RangeInput, Object.assign({}, props, { onChange: onChange, disabled: disabled })));
            case 'currency':
                return (_jsx(CurrencyInput, Object.assign({}, props, { onChange: onChange, disabled: disabled })));
            case 'html':
