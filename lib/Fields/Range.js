...
const RangeInput = (props) => {
    const { label = '', placeholder = '0', name = '', required = false, width = 6, min = 0, max = 100, disabled = false, hasTicks = false, hasLabels = false, onChange, type, value, } = props;
