...
const Country = (props) => {
    var _a, _b, _c, _d;
    const { onChange, disabled = false, placeholder = '', required, name = '', label = '', width = 6, region = 'world', help, customErrorMessage, value, className = '', tabIndex, id, } = props;
    ...
    return (_jsxs("div", { className: classes, style: {
        ...
        }, children: [_jsx("label", { children: label }), _jsxs("select", { name: name, required: required, disabled: disabled, onBlur: () => setTouched(true), onChange: onChangeHandler, ref: inputRef, value: selectedCountry, id: id, tabIndex: tabIndex, children: [_jsx("option", { value: "", disabled: true, children: help !== null && help !== void 0 ? help : 'Make a selection' }), countries.map((country, index) => {
