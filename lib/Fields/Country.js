...
const Country = (props) => {
    ...
    return (_jsxs("div", { className: classes, style: {
        ...
        }, children: [_jsx("label", { children: label }), _jsxs("select", { name: name, required: required, disabled: disabled, onChange: onChangeHandler, ref: inputRef, value: selectedCountry, children: [_jsx("option", { value: "", disabled: true, children: emptyOption !== null && emptyOption !== void 0 ? emptyOption : 'Make a selection' }), countries.map((country, index) => {
