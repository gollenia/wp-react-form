...
const Select = (props) => {
    var _a, _b, _c, _d;
    const { onChange, options, hasEmptyOption, help, hint, disabled, placeholder, multiple, required, label, name, customErrorMessage, width, } = props;
    ...
    return (_jsxs("div", { className: classes, style: {
        ...
        }, children: [_jsx("label", { children: label }), _jsxs("select", { name: name, required: required, onChange: onChangeHandler, onBlur: () => setTouched(true), autoComplete: hint, disabled: disabled, multiple: multiple, defaultValue: placeholder, children: [hasEmptyOption && (_jsx("option", { value: "", disabled: true, children: help !== null && help !== void 0 ? help : 'Make a selection' })), options &&
