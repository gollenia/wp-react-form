...
const Select = (props) => {
    var _a, _b, _c, _d;
    const { onChange, options = [], hasEmptyOption = true, help, hint, disabled = false, placeholder = '', multiple, required, label = '', name = '', customErrorMessage, width = 6, value, tabIndex, className = '', id, } = props;
    ...
    return (_jsxs("div", { className: classes, style: {
        ...
        }, children: [_jsx("label", { children: label }), _jsxs("select", { name: name, required: required, onChange: onChangeHandler, onBlur: () => setTouched(true), ref: inputRef, autoComplete: hint, disabled: disabled, tabIndex: tabIndex, multiple: multiple, defaultValue: placeholder, value: value, id: id, children: [hasEmptyOption && (_jsx("option", { value: "", disabled: true, children: help !== null && help !== void 0 ? help : 'Make a selection' })), _jsx(Options, {})] }), isTouched &&
