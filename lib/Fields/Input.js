...
const TextInput = (props) => {
    ...
    return (_jsxs("div", { className: classes, style: {
        ...
        }, children: [_jsx("label", { children: label }), _jsx("input", Object.assign({}, minMax, { placeholder: props.placeholder, name: props.name, required: required, onBlur: () => setTouched(true), type: type, autoComplete: props.autoComplete, disabled: props.disabled, pattern: pattern ? pattern : undefined, defaultValue: props.defaultValue, value: value, ref: inputRef, onInvalid: setInvalidity, onChange: onChangeHandler, onBeforeInput: onKeyPressHandler })), !((_b = inputRef === null || inputRef === void 0 ? void 0 : inputRef.current) === null || _b === void 0 ? void 0 : _b.validity.valid) && isTouched && ((_c = inputRef.current) === null || _c === void 0 ? void 0 : _c.validationMessage) && (_jsx("span", { className: "error-message", children: customErrorMessage || ((_d = inputRef.current) === null || _d === void 0 ? void 0 : _d.validationMessage) }))] }));
};
