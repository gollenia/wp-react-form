  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    FieldWrapper_default,
    {
      ...
      children: [
        ...
        isOpen && !disabled && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { id: listboxId, role: "listbox", className: "ctx2-combobox-listbox", children: [
          clearEnabled && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            "button",
            {
              type: "button",
              role: "option",
          ...
          filteredOptions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "muted", role: "presentation", children: noResultsLabel })
        ] })
      ]
    }
  );
...
var RangeInput = (props) => {
  ...
  const rangeRef = (0, import_element7.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: classes, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "ctx2-range__set", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "ctx2-range__control", children: [
        ...
        hasTicks && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "ctx2-range__ticks", "aria-hidden": "true", children: [...Array(max - min + 1)].map((_, index) => {
...
var Select = (props) => {
  ...
  const selectRef = (0, import_element8.useRef)(null);
  ...
  const normalizedOptions = (0, import_element8.useMemo)(() => {
    if (!options) return [];
    ...
    FieldWrapper_default,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        "select",
        {
          ...
          onInvalid: handleInvalid,
          children: [
            hasEmptyOption && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: "", disabled: required, children: emptyOptionLabel }),
            normalizedOptions.map((option) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: option.value, children: option.label }, option.value))
          ]
        }
      )
    }
...
function Stepper({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: ["ctx2-stepper", className].filter(Boolean).join(" "), children: [
...
var TextArea = (props) => {
  ...
  const textAreaRef = (0, import_element9.useRef)(null);
  const [touched, setTouched] = (0, import_element9.useState)(false);
  const reactId = (0, import_element9.useId)();
...
var import_element10 = require("@wordpress/element");
...
var HTMLBlock = ({ content = "", role }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(RenderHtml, { className: classes, role, html: content });
};
...
var InputField = (props) => {
  ...
  switch (type) {
    ...
    case "html":
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(HtmlBlock_default, { content: props.content, width: props.width });
    case "hidden":
      return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(
        Hidden_default,
        {
...
function Fieldset({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("div", { className: "ctx-form-fields", children: visibleFields.map((field) => /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)(
    "div",
    {
      className: `ctx-form-fields__item ctx-width--${field.width ?? 6}`,
      "data-testid": field.testId,
      children: [
        field.description && /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("p", { className: "ctx-form-field-description", children: field.description }),
...
var Form = (props) => {
  ...
  const [status, setStatus] = (0, import_element10.useState)("LOADING");
  const [fields, setFields] = (0, import_element10.useState)([]);
  const [form, setForm] = (0, import_element10.useState)({});
  const [response, setResponse] = (0, import_element10.useState)();
  const [touched, setTouched] = (0, import_element10.useState)(false);
  (0, import_element10.useEffect)(() => {
    onStateChange?.(status);
  }, [status]);
  const formRef = (0, import_element10.useRef)(null);
  (0, import_element10.useEffect)(() => {
    if (!formUrl && data) {
      setFields(data);
      setStatus("LOADED");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(
    "form",
    {
      ...
      onReset: resetForm,
      children: [
        status === "ERROR" && /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
          RenderHtml,
          {
            tag: "div",
            role: "alert",
