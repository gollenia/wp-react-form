...
const NumberInput = (props) => {
    ...
    return (_jsx(_Fragment, { children: range ? (_jsxs("div", { className: classes, children: [_jsx("label", { children: label }), _jsxs("div", { className: "range__set", children: [_jsxs("div", { className: "range__control", children: [_jsx("input", { value: rangeValue, name: name, required: required, disabled: disabled, type: "range", max: max, min: min, style: rangeStyle, ref: rangeRef, onChange: onChangeHandler }), hasTicks && (_jsx("div", { className: "range__ticks", children: [...Array(max - min + 1)].map((e, i) => {
                                        return (_jsx("div", { className: "range__tick" }, i));
                                    }) })), hasLabels && (_jsxs("div", { className: "range__labels", children: [_jsx("span", { className: "range__label", children: min }), _jsx("span", { className: "range__label", children: max })] }))] }), _jsx("span", { className: "range__value", children: rangeValue })] })] })) : (_jsxs("div", { className: classes, children: [_jsx("label", { children: label }), _jsx("input", { value: rangeValue, name: name, required: required, disabled: disabled, type: "number", max: max, min: min, ref: rangeRef, onChange: onChangeHandler })] })) }));
};
